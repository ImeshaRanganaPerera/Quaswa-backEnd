...
export const dashboardFiguresByUser = async (month?: number, year?: number) => {
    ...
    const groupByAuthUser = (vouchers: any[]): { [key: string]: any } => {
    ...
    // Populate users without invoices or sales returns
